...
public class HelloRepository {
    ...
    private static final Hello FIRST_GREETING = new Hello("First greeting");
    private static final Hello SECOND_GREETING = new Hello("Second greeting");
    private static final Hello THIRDY_GREETING = new Hello("Thirdy greeting");
